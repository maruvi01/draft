...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { body: @memo.body, tag: @memo.tag, tag_id: @memo.tag_id, user_id: @memo.user_id } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { body: @memo.body, tag: @memo.tag, tag_id: @memo.tag_id, user_id: @memo.user_id } }
